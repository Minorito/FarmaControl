...
$check = mysqli_query($link, "SELECT * from produto WHERE codProduto = '$codProduto'");   //CHECANDO SE O ID JA EXISTE 
  ...
  if ((mysqli_num_rows($check) > 0)==TRUE) {
   echo "<p align='center'><font color='red'><b>Código de produto já está cadastrado!</b></font></p>";   
    ...
    $insert = mysqli_query($link, "INSERT INTO produto(codProduto,laboratorio,nome,tarja,preco,codBarras,formaApresentacao,quantidadeEstoque) 
    values('$codProduto','$laboratorio','$nome','$tarja','$preco','$codBarras','$formaApresentacao','$quantidadeEstoque')");
  }
?>
@endsection